...
A userscript for quickly checking anime opening and ending theme information from Bangumi and Annict work pages. Copy song and artist names, open Mora previews or product pages, and search for tracks on YouTube.
...
3. Open a supported Bangumi or Annict page.
...
On a work page, select “Anison” beside the title. On a list page, use the “A” button for a work. The theme-song list opens on the same page, with Mora and YouTube actions on each row and copy buttons beside song and artist names.
...
This script does not collect usage data or personal information. It sends requests to Anison Generation and Mora when searching for works or tracks. Display settings, including the selected language, are stored in the browser’s `localStorage`.
